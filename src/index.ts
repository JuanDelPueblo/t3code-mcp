  ...
  const server = new McpServer(
    ...
    },
    {
      instructions: [
        ...
        "   reuse one.",
        "4. Call t3_send_message to start another turn on an existing thread;",
        "   unlike t3_send_prompt it never creates a project, thread, branch,",
        "   or worktree.",
        "5. Inspect current state with t3_get_thread or t3_get_status; both return",
        "   an immediate snapshot and work for threads from any client.",
        "6. Use t3_interrupt or t3_stop_session for lifecycle control.",
      ].join("\n"),
    },
  );
